...
const InfoBox: React.FC<InfoBoxProps> = ({ customClass }) => {
  ...
  return (
    <div className="flex w-10/12 flex-col items-center justify-between rounded-[20px] bg-primaryDark p-10 dark:bg-primary md:p-16 lg:w-8/12 lg:flex-row lg:items-start lg:p-24">
